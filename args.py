...
def get_setup_args():
    ...
    parser.add_argument('--train_url',
                        type=str,
                        default='https://raw.githubusercontent.com/DiscoverAI/squad/master/data/train-v2.0.json')
    parser.add_argument('--dev_url',
                        type=str,
                        default='https://raw.githubusercontent.com/DiscoverAI/squad/master/data/dev-v2.0.json')
    parser.add_argument('--test_url',
                        type=str,
                        default='https://raw.githubusercontent.com/DiscoverAI/squad/master/data/test-v2.0.json')
